	...
	if(isset($_POST['song_name'])){
		...
		if(isset($_FILES['song_mp3']['error'])){
			if($_FILES['song_mp3']['error'] == 0){
				...
				$song_mp3 = time()."_".rand(100000,10000000).rand(100000,10000000);
		...
		$SQL = "INSERT INTO songs(
						song_mp3,song_photo,artist_id,song_name
					)VALUES(
						'{$song_mp3}','{$song_photo}','{$artist_id}','{$song_name}'
					)
				";
			...
			<form method="post" action="admin_song_upload.php" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
 			  ...
 			  <div class="form-group">
			    ...
			    <input type="file"  name="song_photo" accept=".jpg,.jpeg,.png" class="form-control" id="song_photo"> 
			  </div>
